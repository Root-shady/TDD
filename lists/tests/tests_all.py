...
class HomePageTest(TestCase):
    ...
    ## Sending the variables to the template directly, instead of the post
    ## but how to determine it is a get or post method.
...
class ListViewTest(TestCase):
    ...
    def test_displays_all_items(self):
        ...
        # Instead of using slightly annoying assertIn/response.content.decode() dance, 
        # Django provides the asssertContains method which knows how to deal with responses 
